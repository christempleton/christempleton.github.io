...
birds=read.csv("NoiseVocal3.csv", header=T) # READ IN MASTER DATA
...
#### SURVEY DATA ANALYSIS, LMMS BY HAND ####
...
#### ORIGINAL SURVEY RESULTS TABLE CREATION ####
...
output_file <- "Raw_Survey_LMM_Full_Results_Revision1.0.xlsx"
...
#### EXPERIMENT DATA ANALYSIS, LMMS BY HAND ####
...
#### ORIGINAL EXPERIMENT RESULTS TABLE CREATION ####
extract_lmm_results <- function(models_list, model_names, output_file) {
  result_list <- list()
...
# Create output file name
output_file <- "Raw_Experiment_LMM_Full_Results_Revision1.0.xlsx"
...
SWTH_survey_full_BW_plot= ggplot() +
  ...
  xlab("Ambient noise level (dB)") +
  ylab("Bandwidth (Hz)") +
  annotate("text", x=29, y=7100, label= "C", size=10) +
...
grid.arrange(SWTH_survey_full_PFCMin_plot, SWTH_survey_full_PFCMax_plot, SWTH_survey_full_BW_plot, SWTH_survey_full_Peak.Freq_plot, SWTH_survey_full_Dur.90_plot, ncol = 3, nrow = 2)
...
SWTH_survey_intro_BW_plot= ggplot() +
  ...
  xlab("Ambient noise level (dB)") +
  ylab("Bandwidth (Hz)") +
  annotate("text", x=30, y=1500, label= "C", size=10) +
  theme_classic(base_size = 20) +  # Set a base size for all text elements
  theme(
    axis.title = element_text(size = 18),
    axis.text = element_text(size = 14)
...
# Arrange the above 7 plots
grid.arrange(SWTH_survey_intro_PFCMin_plot, SWTH_survey_intro_PFCMax_plot, SWTH_survey_intro_BW_plot, SWTH_survey_intro_Peak.Freq_plot, SWTH_survey_intro_Dur.90_plot, ncol = 3, nrow = 2)
...
SWTH_experiment_full_BW_plot = ggplot(summary_data, aes(x = Trial_type, y = mean_value, color = as.factor(IndividualID), group = IndividualID)) +
  ...
  annotate("text", x=.7, y=6000, label= "C", size=10) +
  theme_classic(base_size = 20) +  # Set a base size for all text elements
  theme(
    axis.title = element_text(size = 18),
    axis.text = element_text(size = 14)
...
grid.arrange(SWTH_experiment_full_PFCMin_plot, SWTH_experiment_full_PFCMax_plot, SWTH_experiment_full_BW_plot, SWTH_experiment_full_Peak.freq_plot, SWTH_experiment_full_Dur.90_plot, SWTH_song_rate_plot, ncol = 3, nrow = 2) #added song rate plot too
...
SWTH_experiment_intro_BW_plot = ggplot(summary_data, aes(x = Trial_type, y = mean_value, color = as.factor(IndividualID), group = IndividualID)) +
  ...
  annotate("text", x=.7, y=800, label= "C", size=10) +
  theme_classic(base_size = 20) +  # Set a base size for all text elements
  theme(
    axis.title = element_text(size = 18),
    axis.text = element_text(size = 14)
...
# Arrange the above 5 plots
grid.arrange(SWTH_experiment_intro_PFCMin_plot, SWTH_experiment_intro_PFCMax_plot, SWTH_experiment_intro_BW_plot, SWTH_experiment_intro_Peak.freq_plot, SWTH_experiment_intro_Dur.90_plot, ncol = 3, nrow = 2) #added song rate plot too
...
SWTH_experiment_full_BW_barplot = ggplot(summary_data, aes(x = Trial_type, y = mean_value)) +
  ...
  coord_cartesian(ylim = c(2500, 4800)) +
  annotate("text", x=.7, y=4800, label= "C", size=10) +
  theme_classic(base_size = 20) +  # Set a base size for all text elements
  theme(
    axis.title = element_text(size = 18),
    axis.text = element_text(size = 14)
...
# Arrange the above 7 plots
grid.arrange(SWTH_experiment_full_PFCMin_barplot, SWTH_experiment_full_PFCMax_barplot, SWTH_experiment_full_BW_barplot, SWTH_experiment_full_Peak.freq_barplot, SWTH_experiment_full_Dur.90_barplot, SWTH_song_rate_bar, ncol = 3, nrow = 2)
...
# Arrange the above 5 plots
grid.arrange(SWTH_experiment_intro_PFCMin_barplot, SWTH_experiment_intro_PFCMax_barplot, SWTH_experiment_intro_BW_barplot, SWTH_experiment_intro_Peak.freq_barplot, SWTH_experiment_intro_Dur.90_barplot, ncol = 3, nrow = 2)
...
model_list <- list(
  lmm_SWTH_experiment_full_BW, lmm_SWTH_experiment_full_Dur.90, 
  lmm_SWTH_experiment_full_PFC.Max, lmm_SWTH_experiment_full_PFC.Min, 
  lmm_SWTH_experiment_full_Peak.Freq, lmm_SWTH_rate_Song, 
  lmm_SWTH_experiment_intro_BW, 
  lmm_SWTH_experiment_intro_Dur.90, lmm_SWTH_experiment_intro_PFC.Max, 
  lmm_SWTH_experiment_intro_PFC.Min, lmm_SWTH_experiment_intro_Peak.Freq
)

response_labels <- c(
  "Full song Bandwidth (Hz)", 
  "Full song duration 90% (s)", "Full song PFC maximum frequency (Hz)", "Full song PFC minimum frequency (Hz)", 
  "Full song peak frequency (Hz)", 
  "Full song rate (songs/minute)",
  "Intro note Bandwidth (Hz)", "Intro note duration 90% (s)", "Intro note PFC maximum frequency (Hz)", 
  "Intro note PFC minimum frequency (Hz)", "Intro note peak frequency (Hz)"
)
...
gtsave(gt_table, "Experiment_results_Revision1.0.html")

# Save the table as a Word document
gtsave(gt_table, "Experiment_results_Revision1.0.docx")
...
# Define model names and corresponding response variable labels
model_list <- list(
  lmm_SWTH_survey_full_BW, lmm_SWTH_survey_full_Dur.90, 
  lmm_SWTH_survey_full_PFC.Max.Freq, lmm_SWTH_survey_full_PFC.Min.Freq, 
  lmm_SWTH_survey_full_Peak.Freq, lmm_SWTH_survey_intro_BW, 
  lmm_SWTH_survey_intro_Dur.90, lmm_SWTH_survey_intro_PFC.Max.Freq, 
  lmm_SWTH_survey_intro_PFC.Min.Freq, lmm_SWTH_survey_intro_Peak.Freq
)
...
# Save the table as a HTML
gtsave(gt_table, "Survey_results_Revisions1.0.html")

# Save the table as a Word document
gtsave(gt_table, "Survey_results_Revisions1.0.docx")
...
EMM_SWTH_experiment_full_PFC.Max = emmeans(lmm_SWTH_experiment_full_PFC.Max, ~ Trial_type, lmer.df = "satterthwaite")
...
EMM_SWTH_experiment_full_PFC.Min = emmeans(lmm_SWTH_experiment_full_PFC.Min, ~ Trial_type, lmer.df = "satterthwaite")
...
EMM_SWTH_experiment_intro_PFC.Max = emmeans(lmm_SWTH_experiment_intro_PFC.Max, ~ Trial_type, lmer.df = "satterthwaite")

# PFC Min
lmm_SWTH_experiment_intro_PFC.Min = lmer(PFC.Min.Freq..Hz. ~ Trial_type + (1 | IndividualID), data = SWTH_experiment_intro)
summary(lmm_SWTH_experiment_intro_PFC.Min)

EMM_SWTH_experiment_intro_PFC.Min = emmeans(lmm_SWTH_experiment_intro_PFC.Min, ~ Trial_type, lmer.df = "satterthwaite")
